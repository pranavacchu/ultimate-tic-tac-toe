    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <img
            src="/logo_tic_tac_toe.png"
            alt="Tic Tac Toe Logo"
            className="w-6 h-6"
          />
          <span className="text-xl font-bold tracking-tighter bg-gradient-to-r from-gray-400 to-white text-transparent bg-clip-text">
        ...
        <div className="hidden md:flex items-center space-x-16">
          <button
            ...
            className="nav-link font-medium text-white hover:text-tictac-purple transition-colors duration-300"
          >
            Learn
          </button>
          <a
        ...
        <div className="md:hidden glass-effect mt-4 p-4 rounded-lg animate-fade-in">
          <div className="flex flex-col space-y-4">
            <button
              ...
              className="font-medium text-white py-2 px-4 hover:bg-white/10 rounded transition-colors"
            >
              Learn
            </button>
            <a
